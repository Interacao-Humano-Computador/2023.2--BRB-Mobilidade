...
|Juan|Gustavo|21/11/2023|08:30 - 08:45|Presencial|
...
| 11 | O protótipo deixa claro os caminhos que podem ser tomados? | Fechada |Sim, mas teve uma observação sobre o posicionamento do botão de cancelar|
| 12 | O protótipo se mostrou eficiente para a realização da tarefa? | Fechada |Sim|
| 13 | O que você acha que pode ser modificado para melhorar o protótipo? | Aberta |A questão do botão de cancelar poderia ficar junto com o de salvar (oq ela acha q poderia modificar)|
